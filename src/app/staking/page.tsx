  ...
  const handleDelegation = async () => {
    ...
    if (taoAmountBigInt <= taoBalance.data) {
      try {
        ...
        if (txHash) {
          toast.success(
            `Stake added successfully. Please wait ~1 minute before your new staked balance is reflected. Transaction hash: ${txHash}`,
          );
          setTaoAmount("");
          void refetchStake();
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative px-6 py-2 sm:py-4 lg:px-6 lg:py-12">
          <div className="mx-auto max-w-3xl">
            <div className="relative space-y-6 p-6 sm:space-y-16">
              <div>
                ...
                <BlurWithoutWallet
                  ...
                  message="Connect wallet to Delegate"
                >
                      ...
                      <div className="mt-2 flex items-center justify-between text-gray-800 sm:col-span-2 sm:mt-0">
                        <span className="group relative">
                          ...
                          <span className="absolute bottom-full left-1/2 mb-2 hidden -translate-x-1/2 whitespace-nowrap rounded bg-gray-400 px-2 py-1 text-xs text-white group-hover:block">
                            This value is calculated on chain, will update every
                            1 minute or so.
                          </span>
                        </span>
                      </div>
                  ...
                  <div className="flex justify-center gap-4 pt-6">
                    ...
                    <button
                      className="flex w-40 items-center justify-center gap-2 whitespace-nowrap rounded-md border border-transparent bg-indigo-500 px-4 py-3 text-base font-medium text-white shadow-sm enabled:hover:bg-indigo-600 disabled:opacity-75 sm:px-8"
                      disabled={
                        !connectedAccount || !taoAmount || isUndelegating
                      }
